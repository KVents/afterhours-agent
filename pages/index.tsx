    ...
    <div style={styles.wrap}>
      <div style={styles.page}>
        ...
        {loading ? (
          ...
          <p style={styles.muted}>No leads match these filters.</p>
        ) : (
          <>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  error: { color: '#c0392b' },
  muted: { color: '#888' },
  total: { color: '#888', fontSize: '0.85rem' },
  ...
  td: { borderBottom: '1px solid #f0f0f0', padding: '0.6rem 0.5rem' },
  row: { cursor: 'pointer' },
  ...
  detailLabel: { fontSize: '0.75rem', color: '#999', textTransform: 'uppercase' },
